...
class ErrorResponse extends Response
{
    ...
    public function __construct(string $message, \Throwable $exception = null, int $httpCode = 0)
    {
        ...
        if ($exception !== null && $httpCode === 0 && $exception instanceof \Gelembjuk\WebApp\Exceptions\Exception) {
    ...
    public function getHttpCode(): int
    {
        ...
        if ($this->exception !== null && $this->exception instanceof \Gelembjuk\WebApp\Exceptions\Exception) {
