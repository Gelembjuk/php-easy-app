...
trait ContextTrait {
    ...
    /**
    * This is context object , instance of Gelembjuk\WebApp\Applicaion
    */
     ...
     */
    public static function getInstance(\Gelembjuk\WebApp\Context $context) : static
    {
     ...
     */
    public static function getNewInstance(\Gelembjuk\WebApp\Context $context) : static
    {
        if (isset(static::$readyObject[static::class])) {
            return static::$readyObject[static::class];
        }
     ...
     * Set context object. 
     *
     * @param object $context Gelembjuk\WebApp\Context
     */
