...
use \Gelembjuk\EasyApp\Request\PHPStandard as PHPStandard;
...
use Gelembjuk\EasyApp\Response\Response;
...
class Action {
    ...
    {
        $response = new \Gelembjuk\EasyApp\Response\ErrorResponse("No controller found for this endpoint", null, 404);
        $present_format = $this->decideOutputFormat();
        $presenter = Present\Builder::createPresenter($this->context, $response, $present_format);
        $presenter->buildOutput();
        return $presenter;
