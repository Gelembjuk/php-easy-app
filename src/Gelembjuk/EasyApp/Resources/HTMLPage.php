...
namespace Gelembjuk\EasyApp\Resources;
/**
...
class HTMLPage {
    use \Gelembjuk\EasyApp\ContextTrait;
    ...
    protected function getTemplateFile($template, $locale): array 
    {
        ...
        throw new \Gelembjuk\EasyApp\Exceptions\NotFoundException("Requested template file is not found");
    }
