...
use Gelembjuk\EasyApp\Resources\Localization\Localization as Localization;

class Context {
	public Config $config;
	/**
	 * @var \Gelembjuk\EasyApp\Session\SessionInterface
	 * 
	 ...
	 * Translation object. 
	 * 
	 * @var \Gelembjuk\EasyApp\Resources\Localization\Localization
	 */
	...
	public function __construct(string $applicationRootDirectory = '', ?Config $config = null, ?Session\SessionInterface $session = null) 
	{
		...
		// Null translation
		$this->translation = new Localization();
